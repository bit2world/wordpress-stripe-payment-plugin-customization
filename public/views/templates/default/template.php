...
function asp_get_template( $css_inserted = false ) {
	...
	<div class="asp_product_item">
		...
		<span class="asp_price_amount">Price : %_price_%</span> <span class="asp_new_price_amount"></span> <span class="asp_quantity">%_quantity_%</span>
		<div class="asp_under_price_line">Tax + Shipping : %_under_price_line_%</div>
		</div>
